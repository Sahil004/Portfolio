...
import { ArrowDown, Download, MessageCircle, Layers } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        >
          ...
          JavaScript. 1.6 years crafting fintech, eCommerce &amp; SaaS platforms
        ...
        <motion.div {...fadeUp(0.4)} className="flex flex-wrap gap-3">
          <motion.button
            whileHover={{ y: -2, boxShadow: "0 0 40px rgba(110,115,255,0.4)" }}
            whileTap={{ scale: 0.97 }}
